...
public class TagentPkgDownloadApi extends PrivateBinaryStreamApiComponentBase {
    ...
    public String getToken() {
        return "tagent/pkg/download";
    }

    @Override
    public String getName() {
        return "tagent安装包下载接口";
    }
    ...
    @Input({@Param(name = "id", type = ApiParamType.LONG, desc = "安装包文件id", isRequired = true)})
    @Description(desc = "tagent安装包下载接口")
    @Override
