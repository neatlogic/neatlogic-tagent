...
public class RunnerSaveApi extends PrivateApiComponentBase {
    ...
    @Input({
            ...
            @Param(name = "authType", explode = RunnerAuthType[].class, desc = "认证方式"),//待确认
    })
    @Output({
    })
    ...
    public Object myDoService(JSONObject paramObj) throws Exception {
        ...
        runnerVo.setUrl(runnerVo.getProtocol()+"://"+runnerVo.getHost()+":"+runnerVo.getPort()+Config.RUNNER_ADDRESS()+"/");
